                                ...
                                (async () => {
                                    ...
                                    if (result) {
                                        ...
                                        if (userData.positionshare == false) {
                                            ...
                                            positionBtnText = "Disattiva posizione"; z
                                        } else {
                        ...
                        <View style={profilescreen.objCont}>
                            ...
                            <View style={profilescreen.objContRow}>
                                ...
                                <View style={profilescreen.objElemBox}>
                                    <Text>Arma</Text>
                                    <Artefatto sid={user.sid} id={userData == null ? null : userData.weapon}></Artefatto>
                                </View>

                                {/* edit the background image */}
                                <View style={profilescreen.objElemBox}>
                                    <Text>Armatura</Text>
                                    <Artefatto sid={user.sid} id={userData == null ? null : userData.armor}></Artefatto>
                                </View>

                                <View style={profilescreen.objElemBox}>
                                    <Text>Amuleto</Text>
                                    <Artefatto sid={user.sid} id={userData == null ? null : userData.amulet}></Artefatto>
                                </View>
...
async function loadUserDetails(user) {
    const response = await CommunicationController.getUser(user.sid, user.uid)
        .catch((error) => {
